...
- [#9301](https://github.com/ardatan/graphql-mesh/pull/9301)
  ...
  - Updated dependency
    [`@upstash/redis@^1.37.0` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.37.0) (from
    `^1.36.4`, in `dependencies`)

## 0.1.26

### Patch Changes

- [#9289](https://github.com/ardatan/graphql-mesh/pull/9289)
  [`c5b9f3a`](https://github.com/ardatan/graphql-mesh/commit/c5b9f3a281ebab57b26e3d2fb8092fa9f766d83d)
  Thanks [@dependabot](https://github.com/apps/dependabot)! - dependencies updates:
  - Updated dependency
    [`@upstash/redis@^1.36.4` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.36.4) (from
    `^1.36.3`, in `dependencies`)
...
- [#9274](https://github.com/ardatan/graphql-mesh/pull/9274)
  ...
  Thanks [@dependabot](https://github.com/apps/dependabot)! - dependencies updates:
  - Updated dependency
    [`@upstash/redis@^1.36.3` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.36.3) (from
    `^1.36.2`, in `dependencies`)
...
- [#9203](https://github.com/ardatan/graphql-mesh/pull/9203)
  ...
  Thanks [@dependabot](https://github.com/apps/dependabot)! - dependencies updates:
  - Updated dependency
    [`@upstash/redis@^1.36.2` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.36.2) (from
    `^1.36.1`, in `dependencies`)
- Updated dependencies
...
- [#9130](https://github.com/ardatan/graphql-mesh/pull/9130)
  [`9f3f134`](https://github.com/ardatan/graphql-mesh/commit/9f3f134dd726a7e0d698d8461e42114d73367ae2)
  Thanks [@dependabot](https://github.com/apps/dependabot)! - dependencies updates:
  - Updated dependency
    [`@upstash/redis@^1.36.1` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.36.1) (from
    `^1.36.0`, in `dependencies`)
- Updated dependencies
...
- [#9066](https://github.com/ardatan/graphql-mesh/pull/9066)
  ...
  Thanks [@dependabot](https://github.com/apps/dependabot)! - dependencies updates:
  - Updated dependency
    [`@upstash/redis@^1.35.8` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.35.8) (from
    `^1.35.7`, in `dependencies`)

- [#9104](https://github.com/ardatan/graphql-mesh/pull/9104)
  [`d20f374`](https://github.com/ardatan/graphql-mesh/commit/d20f37493932889861808e4f3eae91d1512e66ab)
  Thanks [@dependabot](https://github.com/apps/dependabot)! - dependencies updates:
  - Updated dependency
    [`@upstash/redis@^1.36.0` ↗︎](https://www.npmjs.com/package/@upstash/redis/v/1.36.0) (from
    `^1.35.8`, in `dependencies`)
